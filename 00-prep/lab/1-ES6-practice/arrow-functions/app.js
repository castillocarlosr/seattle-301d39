...
// this is calling that particular object where is has the joe method.
// 2. What is "this" when joe.scopeArrow() is invoked?
// this in a scopeArror is calling the object constructor which has no 'this' method.
// 3. Explain why "this" is different when an arrow function is used.
// In an arrow function, they are best suited for non-method functions.  When 'this' is an arrow function, it bubbles up to the window which does not exsist.
