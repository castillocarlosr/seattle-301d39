...
function displayPics(){
  ...
  //When I changed the var to let in line 33 we changed the accessibility to be limited to inside the function code block.
  //This is a case where var has to be used inside the function.
  console.log(viewed);
